...
[![Build com.thecroods.resitrack.enums.Status][ci-image]][ci-url]
...
a few different projects:
  ...
  * The [IANA com.thecroods.resitrack.enums.Status Code Registry](https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml)
